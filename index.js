...
async function fetchReply(productName, productDesc, targetMarket){
  const url = 'https://janetan26--itom6219.netlify.app/.netlify/functions/fetchAI';
...
async function fetchCompetitors(productName, productDesc, targetMarket ) {
  const url = 'https://janetan26--itom6219.netlify.app/.netlify/functions/fetchCompetitors';
